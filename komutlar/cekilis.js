                    ...
                    msg.edit('🎉**| Şimdi de ödülü yaz bakalım**').then(msg => {
                      message.channel.awaitMessages(filter, {
                        ...
                        try {
                          ...
                          .setFooter(message.author.username + " (Diablo | Çekiliş Sistemi)", message.author.avatarURL);
                          message.guild.channels.find("name" , room).send(' :heavy_check_mark: **ÇEKİLİŞ BAŞLADI** :heavy_check_mark:' , {embed: giveEmbed}).then(m => {
                             ...
                             setTimeout(() => {
                               ...
                               .setTitle(title)
                               .setColor("PURPLE")
                    .setFooter("(Diablo | Çekiliş Sistemi)")
                               .setTimestamp()
                             m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});

                               var embedLel = new Discord.RichEmbed()
                                .setColor("PURPLE")
                                .setDescription("Ödülünü Moderatörleri Etiketleyerek Alabilirsin!").setFooter("(Diablo | Çekiliş Sistemi)")
